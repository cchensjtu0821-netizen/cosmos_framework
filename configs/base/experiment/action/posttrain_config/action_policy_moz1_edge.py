    ...
    datasets=dict(
        moz1=dict(
            ...
            dataset=L(get_action_moz1_sft_dataset)(
                ...
                left_gripper_state_feature="left_gripper_state",
                right_state_feature="rightarm_state_cart_pos",
                right_gripper_state_feature="right_gripper_state",
                torso_state_feature="torso_state_cart_pos",
                left_action_feature="leftarm_action_cart_pos",
                left_gripper_action_feature="left_gripper_action",
                right_action_feature="rightarm_action_cart_pos",
                right_gripper_action_feature="right_gripper_action",
                torso_action_feature="torso_action_cart_pos",
            ),
        )
    ),
)
